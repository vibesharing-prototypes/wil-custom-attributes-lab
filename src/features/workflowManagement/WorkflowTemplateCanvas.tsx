...
import { STATUS_INDICATOR_BG, STATUS_INDICATOR_RING, isProtectedWorkflowState } from "./draftTypes.js";
...
const StateNode: FC<StateNodeProps> = ({ state, isInitial, isSelected, onClick }) => {
  ...
  const isProtected = isProtectedWorkflowState(state);
  ...
  return (
    ...
    >
      <Stack gap={1} height="100%">
        ...
        {/* Protected indicator (guards and/or actions on outgoing transitions) */}
        {isProtected && (
