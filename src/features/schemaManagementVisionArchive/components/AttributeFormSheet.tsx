...
import { AttributeTypeSelector } from "../../schemaManagement/components/AttributeTypeSelector.js";
import { AttributeFormFields } from "../../schemaManagement/components/AttributeFormFields.js";
...
export const AttributeFormSheet: FC<Props> = ({
  ...
  const showDeleteSection =
    Boolean(
      isEditMode &&
        editingAttribute &&
        !editingAttribute.isOotb &&
        editingAttribute.lifecycleStatus === "active" &&
        onRequestDelete,
    );
