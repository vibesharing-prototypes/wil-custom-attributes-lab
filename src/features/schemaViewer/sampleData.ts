 ...
 * Includes one deleted attribute so “Recently deleted” has seed data (attribute not in list).
 */
export const initialAuditLog: AuditLogEntry[] = [
  ...initialCustomAttributes.map((attr) => ({
  ...
  {
    id: "audit-seed-deleted-risk-tier-legacy",
