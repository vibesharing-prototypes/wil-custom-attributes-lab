...
export const STR = {
  ...
  explorations: {
    editFormPreviewNav: t("explorations.editFormPreviewNav", "Edit form (preview)"),
    permissionCardStyles: {
      pageTitle: t("explorations.permissionCardStyles.pageTitle", "Permission card styles"),
      pageSubtitle: t(
        "explorations.permissionCardStyles.pageSubtitle",
        "Compare the responsive role editor control with legacy and alternate patterns for none, view, and edit. Values are interactive for testing.",
      ),
      cardInlineRadioTitle: t(
        "explorations.permissionCardStyles.cardInlineRadioTitle",
        "Inline radio (no chrome)",
      ),
      cardInlineRadioSubtitle: t(
        "explorations.permissionCardStyles.cardInlineRadioSubtitle",
        "Quietest visual weight",
      ),
      cardDropdownTitle: t(
        "explorations.permissionCardStyles.cardDropdownTitle",
        "Compact dropdown",
      ),
      cardDropdownSubtitle: t(
        "explorations.permissionCardStyles.cardDropdownSubtitle",
        "Minimal footprint; trades discoverability",
      ),
      cardIconTitle: t(
        "explorations.permissionCardStyles.cardIconTitle",
        "Icon-only buttons",
      ),
      cardIconSubtitle: t(
        "explorations.permissionCardStyles.cardIconSubtitle",
        "Compact; hover for tooltip",
      ),
      rowOverview: t("explorations.permissionCardStyles.rowOverview", "Overview"),
      rowDetails: t("explorations.permissionCardStyles.rowDetails", "Details"),
      rowAssessment: t("explorations.permissionCardStyles.rowAssessment", "Assessment"),
      rowMitigation: t("explorations.permissionCardStyles.rowMitigation", "Mitigation"),
      rowOwnership: t("explorations.permissionCardStyles.rowOwnership", "Ownership"),
      cardResponsiveTitle: t(
        "explorations.permissionCardStyles.cardResponsiveTitle",
        "Role editor (responsive)",
      ),
      cardResponsiveSubtitle: t(
        "explorations.permissionCardStyles.cardResponsiveSubtitle",
        "Matches roles & permissions: inline radios from the md breakpoint up; compact dropdown below md.",
      ),
      cardLegacyTitle: t(
        "explorations.permissionCardStyles.cardLegacyTitle",
        "Segmented toggle (previous)",
      ),
      cardLegacySubtitle: t(
        "explorations.permissionCardStyles.cardLegacySubtitle",
        "Earlier default before responsive radios / dropdown.",
      ),
    },
  },
  ...
  schemaManagement: {
    ...
    deleteAttributeSheetWarning: t(
      ...
      "Removes this attribute from the active schema. A short summary still appears under Recently deleted, based on change history.",
    ),
  ...
  attributeDeletionDialog: {
    ...
    changeHistoryHint: t(
      ...
      "Recently deleted is a short summary from change history. Open change history for the full trail.",
    ),
  ...
  workflowEditor: {
    ...
    scaffoldNotice: t(
      ...
      "This is a prototype editor. Changes are local only — saving to the Workflows Service API will be available in a later increment.",
    ),
    ...
    addNextStageTooltip: t("workflowEditor.addNextStageTooltip", "Add next lifecycle stage"),
    addNextStageAriaLabel: t("workflowEditor.addNextStageAriaLabel", "Add next stage"),
    emptyCanvasMessage: t(
      "workflowEditor.emptyCanvasMessage",
      "No states yet. Start by adding your first lifecycle stage.",
    ),
    emptyCanvasAction: t("workflowEditor.emptyCanvasAction", "Add first stage"),
    canvasHint: t(
    ...
    addNextStageSectionTitle: t("workflowEditor.addNextStageSectionTitle", "Next stage"),
    addNextStageSectionHint: t(
      "workflowEditor.addNextStageSectionHint",
      "This is a terminal state. Add a next stage to extend the workflow with another step.",
    ),
    addNextStageButton: t("workflowEditor.addNextStageButton", "Add next stage"),
    ...
    graphCanvasHint: t(
      ...
      "Drag nodes to rearrange. Draw a connection from one state to another to add a transition. Delete an edge to remove a transition.",
    ),
